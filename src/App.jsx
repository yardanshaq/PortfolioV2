      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <BlurText
              text="An enthusiastic web and application developer focused on building modern, efficient, and engaging digital experiences through creative and user-centric solutions."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a href="/cv/CV Yardan.pdf" className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors">
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              name="Yardan Shaquille H"
              title="Web Developer"
              handle="yardanshaq"
              status="Online"
              contactText="Contact Me"
              avatarUrl="./assets/yardan.png"
              showUserInfo={true}
              enableTilt={true}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I’m Yardan Shaquille Herlanda, A full-stack developer driven by a passion for creating modern, high-performance applications with seamless and intuitive user experiences. I love exploring cutting-edge technologies such as Artificial Intelligence, Machine Learning, and cloud development, combining innovation with precision to deliver meaningful solutions. With over three years of hands-on experience and more than 20 successful projects, I’m dedicated to empowering users and businesses in the digital age through scalable, functional, and visually appealing products."
                  delay={150}
                  animateBy="words"
                  direction="top"
